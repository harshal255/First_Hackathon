...
const CaserMorals = () => {
    return (
        <div className="CaserMoral flex flex-col h-[40rem]  bg-black rounded-[1rem] m-2 p-2 xl:w-[24rem]">
            <div className=' text-center h-[3rem] bg-[#26003b]  rounded-[12px] p-2 w-[95%] ml-3 text-[1.5rem]'>Cesar Morals</div>
            <div className=" flex   mt-2 p-2 h-[4rem] text-center justify-center items-center flex-col">
                ...
                <div className="info flex flex-col text-start m-3 w-[95%] bg-gray-900 p-5 justify-between">
